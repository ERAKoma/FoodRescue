...
class _ProfileState extends State<Profile> {
  ...
  Future<void> _getImage(ImageSource source, String email) async {
    ...
    if (pickedFile != null) {
      var uri = Uri.parse('http://172.16.7.195:8080/upload_profile_pic/$email');
  ...
  Future<void> _updateUserDetails() async {
    ...
    final response = await http.put(
      Uri.parse('http://172.16.7.195:8080/update_user'),
  ...
  Future<void> _changePassword() async {
    ...
    final response = await http.put(
      Uri.parse('http://172.16.7.195:8080/change_password/${user.email}'),
      headers: {'Content-Type': 'application/json'},
      body: json.encode({
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            child: Container(
              height: 245,
              color: Color.fromARGB(255, 0, 2, 141),
            ),
          ),
